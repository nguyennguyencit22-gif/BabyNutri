...
const HomeTabIcon = ({ focused, color, size }: { focused: boolean; color: string; size: number }) => (
    <TabIcon focused={focused} color={color} size={size} iconName={focused ? "home" : "home-outline"} />
);

const CommunityTabIcon = ({ focused, color, size }: { focused: boolean; color: string; size: number }) => (
    <TabIcon focused={focused} color={color} size={size} iconName={focused ? "message" : "message-outline"} />
);

const LibraryTabIcon = ({ focused, color, size }: { focused: boolean; color: string; size: number }) => (
    <TabIcon focused={focused} color={color} size={size} iconName={focused ? "layers" : "layers-outline"} />
);

const ProfileTabIcon = ({ focused, color, size }: { focused: boolean; color: string; size: number }) => (
    <TabIcon focused={focused} color={color} size={size} iconName={focused ? "account" : "account-outline"} />
);
